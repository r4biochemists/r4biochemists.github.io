---
title: "R5: Plotting your data in R"
author: "Modesto"
date: "August 19, 2024"
...
For a guidance, you can use the *Chartchooser* above, by Andrew Abela, or the interactive website Visual Vocabulary [here](https://ft-interactive.github.io/visual-vocabulary/). Also, I strongly recommend you to check the [*FriendsDontLetFriends*](https://github.com/cxli233/FriendsDontLetFriends) repo with examples of very common mistakes when plotting data in biology.
...
We have a vector in a *RData* file called [primes.RData](data/primes.RData) that we would like to plot.
...
# Create complex plots in base R
...
# [Review exercises 1: R base plots]{style="color:darkgreen"}[^1]

[^1]: Check proposed answers in the repo: <https://github.com/r4biochemists/r4biochemists.github.io/tree/main/answers2exercises>
...
2.  **Use the linear model to obtain the concentration (µM) of *wt* and *mutant* protein preparations. You can use the equation or check out the function `predict()` to directly interpolate the values. Consider the same molecular weight of 99 kDa for both proteins.**

# GGplotting: Advanced plots with `ggplot2` library {#ggplot}

Data visualization is one of the greatest advantage of R. One can quickly go from idea to data to graph with a unique balance of flexibility and ease.
...
::: callout-note
This is a quite large dataframe, if your plotting is too slow or crash your R session, you can randomly select some rows using the function `sample()`

Example:
`vaccines_short <- vaccines[sample(1:nrow(vaccines),100000),]`
:::
...
As mentioned above, *ggplot* is already an standard and the base of many derivative packages. We are going to see a couple of examples, but there are many, including packages for specific tasks, like working with maps or sequences. We will see in the lesson [R8](r9.html) the packages `ggmsa()` and `ggseqlogo()`.
...
# [Review exercises 2: `ggplot`]{style="color:green"}
...
-   R Bloggers exercises with `ggplot2`: <https://www.r-bloggers.com/2016/09/advanced-base-graphics-exercises/>
...
6.  I also advise checking articles and posts that you can find with Google, such as:
    ...
    -   ♨️♨️ Friends Don't Let Friends Make Bad Graphs ♨️♨️: <https://github.com/cxli233/FriendsDontLetFriends>
...
7.  R Graphics Cookbook: <https://r-graphics.org/> (I recommend the Appendix A: Understanding ggplot).

8.  **GGplot cheatsheet:** <https://www.maths.usyd.edu.au/u/UG/SM/STAT3022/r/current/Misc/data-visualization-2.1.pdf>


9.  `ggplot2` in "Introducción a la ciencia de datos" (Spanish!): <http://rafalab.dfci.harvard.edu/dslibro/ggplot2.html>

10.  **"Una breve introducción a ggplot" by Prof. José Ramón Berrendero \@UAM (Spanish!):** <http://verso.mat.uam.es/~joser.berrendero/R/introggplot2.html>

11.  Color palettes in R: <https://www.datanovia.com/en/blog/top-r-color-palettes-to-know-for-great-data-visualization/>

12.  Awesome `ggplot2` addons and tricks: <https://github.com/erikgahner/awesome-ggplot2>
