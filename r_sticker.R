...
sticker(p, package="R4Biochemists", p_size=22, s_x=0.95, s_y=.85, s_width=1.6, s_height=1.1, h_fill="#bde2ff", h_color="#17489c",p_color="#17489c",
        p_family = "gochi", filename="r4biochemists.png", url="r4biochemists.github.io",u_size = 6.3,u_color="#17489c",spotlight = TRUE,l_x = 0.5,l_y=0.75)
